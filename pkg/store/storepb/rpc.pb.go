...
type InfoResponse struct {
	...
	// To avoid sending requests to this node in some cases.
	BloomFilter []byte `protobuf:"bytes,6,opt,name=bloomFilter,proto3" json:"bloomFilter,omitempty"`
	// To be able to differentiate between different bloom filter versions/content's structure.
	BloomFilterVersion int64 `protobuf:"varint,7,opt,name=bloomFilterVersion,proto3" json:"bloomFilterVersion,omitempty"`
	// The size of the bloom filter in bits.
	BloomFilterSize int64 `protobuf:"varint,8,opt,name=bloomFilterSize,proto3" json:"bloomFilterSize,omitempty"`
}
...
var fileDescriptor_a938d55a388af629 = []byte{
	...
	,
}
...
func (m *InfoResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BloomFilterSize != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.BloomFilterSize))
		i--
		dAtA[i] = 0x40
	}
	if m.BloomFilterVersion != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.BloomFilterVersion))
		i--
		dAtA[i] = 0x38
	}
	if len(m.BloomFilter) > 0 {
		...
		i = encodeVarintRpc(dAtA, i, uint64(len(m.BloomFilter)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *InfoResponse) Size() (n int) {
	...
	if m.BloomFilterVersion != 0 {
		n += 1 + sovRpc(uint64(m.BloomFilterVersion))
	}
	if m.BloomFilterSize != 0 {
		n += 1 + sovRpc(uint64(m.BloomFilterSize))
	}
	return n
}
...
func (m *InfoResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BloomFilterVersion", wireType)
			}
			m.BloomFilterVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRpc
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BloomFilterVersion |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BloomFilterSize", wireType)
			}
			m.BloomFilterSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BloomFilterSize |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
